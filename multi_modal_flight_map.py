...
def update_view(mode, find_route_clicks, find_all_clicks, show_flights_clicks, slider_value,
    ...
    if triggered_id == 'mode-switcher':
        current_mode = mode
    elif triggered_id in ['find-route-button', 'source-airport-dropdown', 'destination-airport-dropdown']:
        current_mode = 'route'
    elif triggered_id in ['find-all-routes-button', 'all-routes-source-dropdown', 'all-routes-dest-dropdown', 'num-flights-input']:
        current_mode = 'all_routes'
    elif triggered_id in ['show-flights-button', 'single-airport-dropdown']:
        current_mode = 'single_airport'
    elif triggered_id == 'degree-slider':
